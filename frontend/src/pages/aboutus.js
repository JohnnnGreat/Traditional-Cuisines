      ...
      <div>
        ...
        <div className="about-p">
          <div className="wrapper-p">
            <p>
              Welcome to Heritage Hub, a culinary journey that celebrates the rich
              ...
              Heritage Hub, we invite you to savor the authenticity, embrace the
              traditions, and join us on a delicious voyage through the heart of
              Nigerian gastronomy.
            </p>

            <p>
              Heritage Hub is a Nigerian traditional cuisine website that
